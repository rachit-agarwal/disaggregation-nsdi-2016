...
To determine the impact of a varying local cache size, we evaluated local cache sizes from 10\% to 90\% of the virtual memory space size of $29.45$GB. Figure~\ref{fig:rmem} show how the number of flows (Figure~\ref{fig:rmem_numflows}) and traffic volume (Figure~\ref{fig:rmem_trafvol}) vary.

...
For IO blades: many IO device controllers now support virtualization via PCIe SR-IOV~\cite{sriov} or MR-IOV features and the same can be leveraged to virtualize IO resources in \dis. \sr{need citations for features}

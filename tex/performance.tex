...
%
\item \paragraphb{TCP} We implemented TCP without the three-way handshake as a modest performance improvement. We used a retransmission timeout value of $45$us, which we tuned experimentally.
\end{enumerate}
